...
- You need GraalVM Oracle Edition (which is free for development and production under the GFTC license) to get full,
  unrestricted dynamic code reloading without DCEVM.
...
the observation is that ai responds eerily like a human in multiple respects -- there are at least 2 if not 3 things happening here.
